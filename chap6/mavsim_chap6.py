...
# chi_command = signals(dc_offset=np.radians(50), amplitude=np.radians(45), start_time=5.0, frequency = 0.015/2.0)
## FOR COMPARING  LONGITUDINAL-ONLY CONTROL
# chi_command = signals(dc_offset=np.radians(0), amplitude=np.radians(0), start_time=100000.0, frequency = 1.0/1000.0)
